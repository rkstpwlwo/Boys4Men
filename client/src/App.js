...
function App() {
  ...
  return (
    <div>
      <BrowserRouter>
        <div>
          <Nav isLogin={isLogin} LogoutHandler={LogoutHandler} history={history}/>
        </div>
        <div>
          <Switch>
            <div>
              ...
              <Route path="/Mypage">
                <Mypage accessToken={accessToken} region={region} url={url} setAccessToken={setAccessToken} setLogin={setLogin}/>
              </Route>
              <Route path="/Signup">
